...
{
    public static final Item ITEM_MIC = registerItem("item_mic", new Item(new Item.Settings()));
    public static final Item ITEM_MIC_RAW = registerItem("item_mic_raw", new Item(new Item.Settings()));
